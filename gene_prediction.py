# -*- coding: utf-8 -*-
"""
Gene prediction using homology, Hidden Markov Model and PVM prediction.

This gene prediction pipeline was used to generate translated gene model and genomic
location data for a pangenomic analysis of eukaryotes using PanOCT, followed by post-processing
using a custom Python pipeline also included in this repository.
...
Recent changes:
	...
	- Better integrated codebase with PanOCT post-processing pipeline.
...
logfile = open("Predictions.log", "a", 0)
